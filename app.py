...
from scrapers.parsers import collect_full_match_data
...
if __name__ == "__main__":
    ...
    pd.concat(tv_umpire, ignore_index=True).drop_duplicates(subset=["tv_umpire_id"]).to_csv(
        os.path.join(DATA_DIR, "tv_umpire.csv"), index=False
    )
